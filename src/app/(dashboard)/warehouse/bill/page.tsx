          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                ...
                <th className="text-center px-3 py-2.5 font-medium text-gray-600 w-20">พิมพ์</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-100">
              {loading ? (
                ...
                <tr>
                  <td colSpan={7} className="text-center py-12 text-gray-400">ไม่พบข้อมูล</td>
                </tr>
              ) : bills.map((b, i) => (
                <tr key={i} className="hover:bg-blue-50/30 transition-colors">
                  ...
                  <td className="px-3 py-2 text-gray-600 max-w-[200px] truncate">
                    {b.altFabricStruct || b.fabricStruct || '-'} {b.fabricW ? `${b.fabricW}''` : ''} {b.fabricPattern ?? ''}
