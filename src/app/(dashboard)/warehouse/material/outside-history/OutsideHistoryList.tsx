...
export default function OutsideHistoryList() {
  ...
  const [activeTab, setActiveTab] = useState<"detail" | "delete">("detail");
          ...
          <div className="relative bg-white shadow-xl w-full max-w-lg mx-4 overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="flex border-b border-gray-200 shrink-0">
              {([
                ...
                { key: "delete", label: "ลบ" },
              ] as { key: "detail" | "delete"; label: string }[]).map(({ key, label }) => (
              ...
              <>
                <div className="px-5 py-8 text-center flex-1">
                  ...
                  <p className="text-xs text-gray-500 mb-0.5">
                    <span className="font-medium text-gray-700">{selected.yarnType}</span>
