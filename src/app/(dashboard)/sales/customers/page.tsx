  ...
  return (
    <div className="p-4 max-w-full">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-3xl font-semibold text-gray-900">ข้อมูลลูกค้า</h1>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200 text-xs">
                <th className="hidden sm:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-12">
                  ลำดับ
                </th>
                <th className="hidden md:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-14">
                  รหัส
                </th>
                <th className="text-left px-3 py-2.5 font-medium text-gray-600">
                  ชื่อลูกค้า
                </th>
                <th className="hidden lg:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-48">
                  ที่อยู่
                </th>
                <th className="hidden md:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-36">
                  เลขที่ผู้เสียภาษี
                </th>
                <th className="hidden sm:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-28">
                  โทรศัพท์
                </th>
                <th className="hidden sm:table-cell text-left px-3 py-2.5 font-medium text-gray-600 w-24">
                  ประเภท
                </th>
              ...
              {loading ? (
                ...
                customers.map((c, i) => (
                  <React.Fragment key={c.id}>
                    ...
                    >
                      <td className="hidden sm:table-cell px-3 py-2.5 text-xs text-gray-500">
                        {(page - 1) * 20 + i + 1}
                      </td>
                      <td className="hidden md:table-cell px-3 py-2.5 text-xs font-mono text-gray-600">
                        {c.id}
                      </td>
                      ...
                      <td className="hidden md:table-cell px-3 py-2.5 text-xs text-gray-600 font-mono">
                        {c.tax ?? "-"}
                      </td>
                      <td className="hidden sm:table-cell px-3 py-2.5 text-xs text-gray-600">
                        {c.tel ?? "-"}
                      </td>
            ...
            <div className="p-5 space-y-3">
              ...
              {[
                ...
                <div key={key}>
                  ...
                  <input
                    value={(coordForm as Record<string, string>)[key]}
                    onChange={(e) =>
