...
export default function CreateOrderPage() {
  ...
  const [payment, setPayment] = useState(
    "ชำระเงินภายใน 15 วันหลังได้รับสินค้า",
  );
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => {
      fetch(
        `/api/sales/autocomplete/customers?q=${encodeURIComponent(customerSearch)}`,
      )
        .then((r) => r.json())
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="border border-gray-300 bg-white shadow-sm rounded">
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="flex justify-end text-sm text-gray-600" suppressHydrationWarning>
              ...
              <div>
                ...
                {fabricStructure.trim() && (() => {
                  ...
                  const sp = sRaw.split("*").map(s => s.trim()).filter(Boolean);
