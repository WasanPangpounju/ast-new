        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-xl p-6 max-w-sm w-full mx-4">
            ...
            <p className="text-xs text-red-600 mb-5">
              การลบจะลบใบสั่งขายและใบโครงสร้างที่เกี่ยวข้องทั้งหมด
            </p>
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                disabled={deleting}
                className="text-sm px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 disabled:opacity-50 flex items-center gap-1.5"
              >
                {deleting && (
